...
class OrdenDePago extends BaseClass {
	...
	/**
	 *
	 * @ORM\OneToMany(targetEntity="AppBundle\Entity\OrdenDePagoRendicion", mappedBy="ordenDePago", cascade={"persist", "remove"})
	 */
	 ...
	 * Add fechaRendicion
	 *
	 * @param \AppBundle\Entity\OrdenDePagoRendicion $fechaRendicion
	 *
	 * @return OrdenDePago
	 */
	 ...
	 * @param \AppBundle\Entity\OrdenDePagoRendicion $fechaRendicion
	 */
	public function removeFechaRendicion( \AppBundle\Entity\OrdenDePagoRendicion $fechaRendicion ) {
