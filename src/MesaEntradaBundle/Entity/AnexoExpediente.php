 ...
 * @Vich\Uploadable
 * @ORM\Entity(repositoryClass="MesaEntradaBundle\Repository\AnexoExpedienteRepository")
 */
class AnexoExpediente extends BaseClass {
	 ...
	 * @var
	 *
	 * @ORM\ManyToOne(targetEntity="MesaEntradaBundle\Entity\Expediente", inversedBy="anexos")
