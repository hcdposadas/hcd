...
class TextoDefinitivo extends BaseClass {
	...
	/**
     * @Vich\UploadableField(mapping="paseDem", fileNameProperty="pase")
     * @var File
     */
    private $paseFile;
...
//			$this->updatedAt = new \DateTimeImmutable();
     ...
     * @return TextoDefinitivo
     */
    public function setPaseFile(File $file = null)
    {
        $this->paseFile = $file;
...
//			$this->updatedAt = new \DateTimeImmutable();
     ...
     * @return File|null
     */
    public function getPaseFile()
    {
        return $this->paseFile;
    }
	/**
	 * Get id
	 *
    ...
    public function getPase(): ?string
    {
        return $this->pase;
    }

    public function setPase(?string $pase): self
    {
        $this->pase = $pase;
