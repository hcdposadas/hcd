 ...
 * @Vich\Uploadable
 * @ORM\Entity(repositoryClass="MesaEntradaBundle\Repository\AnexoTextoDefinitivoRepository")
 */
class AnexoTextoDefinitivo extends BaseClass {
	 ...
	 * @var
	 *
	 * @ORM\ManyToOne(targetEntity="MesaEntradaBundle\Entity\TextoDefinitivo", inversedBy="anexos")
