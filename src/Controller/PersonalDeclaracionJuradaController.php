...
class PersonalDeclaracionJuradaController extends AbstractController
{
	...
	{
		return $this->render(
			'personal_declaracion_jurada/index.html.twig',
			[
	...
	public function declaraciones(
		...
		return $this->render(
			'personal_declaracion_jurada/indexdeclaraciones.html.twig',
			[
	...
	public function new(Request $request): Response
	{
		...
		$form                      = $this->createForm(
			PersonalDeclaracionJurada1Type::class,
		...
		return $this->render(
			'personal_declaracion_jurada/new.html.twig',
			[
	...
	public function nuevaDDJJ(Request $request, Persona $persona): Response
	{
		...
		return $this->render(
			'personal_declaracion_jurada/nuevaDDJJ.html.twig',
			[
				'personal_declaracion_jurada' => $personalDeclaracionJurada,
				'persona'                     => $persona,
				'form'                        => $form->createView(),
	...
	{
		return $this->render(
			'personal_declaracion_jurada/show.html.twig',
			[
				'personal_declaracion_jurada' => $personalDeclaracionJurada,
			]
		);
	...
	public function edit(Request $request, PersonalDeclaracionJurada $personalDeclaracionJurada): Response
	{
		...
		return $this->render(
			'personal_declaracion_jurada/edit.html.twig',
			[
				'personal_declaracion_jurada' => $personalDeclaracionJurada,
				'form'                        => $form->createView(),
			]
	...
	public function editarDDJJ(Request $request, PersonalDeclaracionJurada $personalDeclaracionJurada): Response
	{
		...
		if ($form->isSubmitted() && $form->isValid()) {
			...
			return $this->redirectToRoute(
				'personal_declaraciones_jurada',
				['persona' => $personalDeclaracionJurada->getLegajo()->getPersona()->getId()]
			);
		}

		return $this->render(
			'personal_declaracion_jurada/editarDDJJ.html.twig',
			[
				'personal_declaracion_jurada' => $personalDeclaracionJurada,
				'form'                        => $form->createView(),
	...
	public function delete(Request $request, PersonalDeclaracionJurada $personalDeclaracionJurada): Response
	{
		if ($this->isCsrfTokenValid(
			'delete' . $personalDeclaracionJurada->getId(),
